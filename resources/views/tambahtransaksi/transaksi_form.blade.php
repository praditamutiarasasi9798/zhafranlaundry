...
<head>
  ...
  <title>Zhafran Laundry| Transaksi</title>
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10 mb-5">
                            <select class="form-control select2" style="width: 100%;" name="nama_customer" id="nama_customer" required>
                                <option disabled selected>-- PILIH --</option>
                                @foreach ($dataCustomer as $kat)
                                <option value="{{$kat->id_customer}}">{{$kat->nama_customer}}</option>
                                @endforeach
                            </select>
                        </div>
